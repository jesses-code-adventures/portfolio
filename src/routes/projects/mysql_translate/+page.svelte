<script>
	...
	const content = `MySQL Translate is a CLI tool that's built in Rust.
...
<svelte:head>
	...
	<meta name="description" content="An sql schema representation sync system by Jesse Williams." />
</svelte:head>
